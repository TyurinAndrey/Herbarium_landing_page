...
$to = "herbarium.jewelry@yandex.ru"; // Здесь нужно написать e-mail, куда будут приходить письма   
$from = "herbarium@herbariumjewelry.ru"; // Здесь нужно написать e-mail, от кого будут приходить письма, например no-reply(собака)epicblog.net
...
echo "<br /><br /><a href='https://herbariumjewelry.ru'>Вернуться на сайт.</a>";
}
?>
